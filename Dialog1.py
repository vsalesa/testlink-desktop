...
[wxID_DIALOG1, wxID_DIALOG1GETCASESBUTTON, wxID_DIALOG1PANEL1, 
 wxID_DIALOG1PLATFORMCHOICE, wxID_DIALOG1PLATFORMLABEL, 
 wxID_DIALOG1PROJECTCHOICE, wxID_DIALOG1PROJECTLABEL, 
 wxID_DIALOG1TESTPLANCHOICE, wxID_DIALOG1TESTPLANLABEL, 
...
class Dialog1(wx.Dialog):
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(self, id=wxID_DIALOG1, name='', parent=prnt,
              pos=wx.Point(848, 205), size=wx.Size(296, 218),
              style=wx.DEFAULT_DIALOG_STYLE, title='Download Test Cases')
        self.SetClientSize(wx.Size(280, 180))
        ...
        self.GetCasesButton = wx.Button(id=wxID_DIALOG1GETCASESBUTTON,
              ...
              pos=wx.Point(8, 152), size=wx.Size(264, 23), style=0)
    ...
    def OnGetCasesButtonButton(self, event):
        if self.CurrentProject and self.CurrentTestPlan and self.CurrentPlatform != 'x':
